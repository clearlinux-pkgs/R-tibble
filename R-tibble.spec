...
Version  : 3.1.4
Release  : 67
URL      : https://cran.r-project.org/src/contrib/tibble_3.1.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tibble_3.1.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630104533
