...
Version  : 1.3.1
Release  : 6
URL      : https://cran.r-project.org/src/contrib/tibble_1.3.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tibble_1.3.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1495052579
