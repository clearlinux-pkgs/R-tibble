...
Version  : 3.0.5
Release  : 54
URL      : https://cran.r-project.org/src/contrib/tibble_3.0.5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tibble_3.0.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610734117
...
/usr/lib64/R/library/tibble/tests/testthat/_snaps/glimpse.md
